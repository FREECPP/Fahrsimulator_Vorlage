...
class ShimmerLogger(Logger):
    ...
    # Bitbreite des Shimmer-Hardware-Timestamps (an den Daten verifiziert: 24 Bit).
    # Der Zähler läuft alle 2**24 / 32768 Hz ≈ 8,5 min um; bei Überlauf wird ein
    # voller Umlauf addiert.
